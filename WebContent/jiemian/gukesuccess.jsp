...
<dt><span class="arrow"></span></dt> 
 <dd><a href="../canzhuo/canzhuoSelect.jsp" target="iframe_a">查询空闲餐桌</a></dd>
    <dd><a href="../dingzhuo/dingzhuoInsert.jsp" target="iframe_a">添加定桌</a></dd>
     <dd><a href="../dingzhuo/dingzhuoDelete.jsp" target="iframe_a">删除定桌</a></dd>
      <dd><a href="../dingzhuo/dingzhuoUpdate.jsp" target="iframe_a">修改定桌</a></dd>
      	<dd><a href="../dingzhuo/dingzhuoSelect.jsp" target="iframe_a">查询定桌</a></dd>
</dl> 
</li> 
<li> 
<span class="Darrow"></span> 
...
<dl> 
<dt><span class="arrow"></span></dt> 
<dd><a href="../diancai/diancaiInsert.jsp" target="iframe_a">添加点菜</a></dd>
    <dd><a href="../diancai/diancaiDelete.jsp" target="iframe_a">删除点菜</a></dd>
     <dd><a href="../diancai/diancaiUpdate.jsp" target="iframe_a">修改点菜</a></dd>
      <dd><a href="../diancai/diancaiSelect.jsp" target="iframe_a">查询点菜</a></dd> 
</dl> 
</li> 
<li><a href="../caidan/caidanSelect.jsp" target="iframe_a">查询顾客菜单</a></li> 
<li><a href="../totalmoney/xiadantotalSelect.jsp" target="iframe_a">查询本次消费金额</a></li> 
